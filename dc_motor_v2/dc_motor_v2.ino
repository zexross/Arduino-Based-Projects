...
void loop() {
  ...
  /*DUMPS("\r\rwhich motor do you want to run? left(1) or right(2):");
 ...
 {
  DUMPS("\r\ryou entered invalid motor no:");
  DUMPS(motor_no);
 }
 DUMPS("\r\rprovide the speed of motor ranging from 0 to 255:");
 while(Serial.available()==0)
  {
    ;
  }
